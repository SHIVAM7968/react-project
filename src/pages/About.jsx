...
function About() {
  return (
    ...
    <div className='bg-white md:p-20 w-full  text-center md:justify-center'>
    <h2 className='font-bold text-5xl shadow-md shadow-yellow-400 rounded-md '>Our sponsors</h2>
    <div className='md:flex md:w-full  md:gap-40 md:justify-center md:pt-10 '>
       <img src={logo1} alt='{logo1}' className='size-28 md:items-center'/>
